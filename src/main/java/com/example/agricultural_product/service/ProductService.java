...
public interface ProductService extends IService<Product> {
	...
	// 根据商品状态，查询去重后的商品名称列表。
	Page<Product> getProductsByStatusPage( String status, String createTime, String productName, Integer pageNum, Integer pageSize);
	...
	Page<Product> getProductsByFarmerIdAndStatusPage(Long farmerId, String status, String createTime, String productName, Integer pageNum, Integer pageSize);
